...
class CSSDeclarationBlockTest extends PHPUnit_Framework_TestCase
{
	...
	{
		return [
	  ['body{ border: 2px solid rgb(0,0,0) }', 'body {border-width: 2px;border-style: solid;border-color: rgb(0,0,0);}'],
	  ['body{ border: none }', 'body {border-style: none;}'],
	  ['body{ border: 2px }', 'body {border-width: 2px;}'],
	  ['body{ border: rgb(255,0,0) }', 'body {border-color: rgb(255,0,0);}'],
	...
	public function expandBackgroundShorthandProvider()
	{
	  ...
	  ['body {background: rgb(255,0,0);}','body {background-color: rgb(255,0,0);background-image: none;background-repeat: repeat;background-attachment: scroll;background-position: 0% 0%;}'],
	  ['body {background: rgb(255,0,0) url("foobar.png");}','body {background-color: rgb(255,0,0);background-image: url("foobar.png");background-repeat: repeat;background-attachment: scroll;background-position: 0% 0%;}'],
	  ['body {background: rgb(255,0,0) url("foobar.png") no-repeat;}','body {background-color: rgb(255,0,0);background-image: url("foobar.png");background-repeat: no-repeat;background-attachment: scroll;background-position: 0% 0%;}'],
	  ['body {background: rgb(255,0,0) url("foobar.png") no-repeat center;}','body {background-color: rgb(255,0,0);background-image: url("foobar.png");background-repeat: no-repeat;background-attachment: scroll;background-position: center center;}'],
	  ['body {background: rgb(255,0,0) url("foobar.png") no-repeat top left;}','body {background-color: rgb(255,0,0);background-image: url("foobar.png");background-repeat: no-repeat;background-attachment: scroll;background-position: top left;}'],
	];
	}
	...
	{
		return [
	  ['body {border-width: 2px;border-style: solid;border-color: rgb(0,0,0);}', 'body {border: 2px solid rgb(0,0,0);}'],
	...
	public function createBackgroundShorthandProvider()
	{
		return [
	  ['body {border: 1px;}', 'body {border: 1px;}'],
	  ['body {background-color: rgb(255,0,0);}', 'body {background: rgb(255,0,0);}'],
	  ['body {background-color: rgb(255,0,0);background-image: url(foobar.png);}', 'body {background: rgb(255,0,0) url("foobar.png");}'],
	  ['body {background-color: rgb(255,0,0);background-image: url(foobar.png);background-repeat: no-repeat;}', 'body {background: rgb(255,0,0) url("foobar.png") no-repeat;}'],
	  ['body {background-color: rgb(255,0,0);background-image: url(foobar.png);background-repeat: no-repeat;}', 'body {background: rgb(255,0,0) url("foobar.png") no-repeat;}'],
	  ['body {background-color: rgb(255,0,0);background-image: url(foobar.png);background-repeat: no-repeat;background-position: center;}', 'body {background: rgb(255,0,0) url("foobar.png") no-repeat center;}'],
	  ['body {background-color: rgb(255,0,0);background-image: url(foobar.png);background-repeat: no-repeat;background-position: top left;}', 'body {background: rgb(255,0,0) url("foobar.png") no-repeat top left;}'],
	  ['body {background-color: rgb(255,0,0);background-image: url(foobar.png);background-repeat: no-repeat;background-position: 0% 0%;}', 'body {background: rgb(255,0,0) url("foobar.png") no-repeat 0% 0%;}'],
	];
	}
