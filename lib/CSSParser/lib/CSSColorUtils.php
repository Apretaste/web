...
class CSSColorUtils
{
	...
	public static function namedColor2rgb($sColor, $bAsString = false)
	{
	...
	public static function rgb2namedColor($r, $g, $b, $a = 1)
	{
		if ($a !== 1) {
			return null;
		}
	 ...
	 **/
	public static function rgb2hex($r, $g, $b, $asString = true)
	{
	 ...
	 * Converts HSL to RGB
	 **/
	public static function hsl2rgb($h, $s, $l, $a = 1)
	{
	...
	private static function hue2rgb($m1, $m2, $h)
	{
		if ($h < 0) {
			$h++;
		}
